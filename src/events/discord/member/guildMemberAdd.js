...
module.exports = {
  ...
  async execute(member, client) {
    ...
    await promises.writeFile(
      join(`assets/img/`, "logolrmn.png"),
      pngData
    );
    const file = new AttachmentBuilder("assets/img/logormn.png");
    /* ------------------------------------------------------------
    ...
    let embed = new EmbedBuilder()
      ...
      .setColor("Random")
      .setImage("attachment://logolrmn.png")
      .setFooter({
        iconURL: client.user.displayAvatarURL(),
        text: `© L RMN all rights reserved\n`,
      })
      .addFields([
        {
          name: `:arrow_right: Invited by :`,
          value: `WORK IN PROGRESS`, //=> TODO: add the inviter name
          inline: true,
        },
        {
          name: `:arrow_right: The server account was now :`,
