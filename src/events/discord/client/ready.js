          ...
          queue.textChannel.send({
            embeds: [
              new EmbedBuilder()
                .setColor("Green")
                .setDescription(
                  `🎶 | Reading of \`${song.name}\` - \`${song.formattedDuration}\``
                )
                .addFields([
                  {
                    name: `Info :`,
          ...
          queue.textChannel.send({
            embeds: [
              new EmbedBuilder()
                .setColor("Green")
                .setDescription(
                  `🎶 | Addition of ${song.name} - \`${song.formattedDuration}\``
                )
                .addFields([
                  {
                    name: `Ask by :`,
          ...
          queue.textChannel.send({
            embeds: [
              new EmbedBuilder()
                .setColor("Green")
                .setDescription(
                  `🎶 | Added playlist \`${playlist.name}\` (${playlist.songs.length} music) to the playlist`
                )
                .addFields([
                  {
                    name: `Info`,
          ...
          queue.textChannel.send({
            embeds: [
              new EmbedBuilder()
                .setColor("Red")
                .setDescription(
                  "⛔ | I feel alone in the vocal lounge, I leave the vocal lounge..."
                )
                .setFooter({
                  text: `Powered by Distube \nUpdated by L RMN \n© L RMN all rights reserved`,
                }),
        ...
        try {
          queue.textChannel.send({
            embeds: [
              new EmbedBuilder()
                .setColor("Green")
                .setDescription("🏁 | Reading list complete!")
                .setFooter({
                  text: `Powered by Distube \nUpdated by L RMN \n© L RMN all rights reserved`,
                }),
            ],
